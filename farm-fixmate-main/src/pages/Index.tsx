  ...
  const handleImageSelect = async (file: File) => {
    try {
      ...
      if (error instanceof Error) {
        ...
        toast.error("ছবি বিশ্লেষণ করতে ব্যর্থ হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।");
      }
    } finally {
        ...
        <div className="container py-8 px-4 mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              আপনার ক্ষতিগ্রস্ত ফসলের ছবি আপলোড করুন এবং AI-এর মাধ্যমে তাৎক্ষণিক বিশ্লেষণ এবং চিকিৎসার পরামর্শ পান।
            </p>
          </div>
          ...
          {isAnalyzing && (
            <div className="flex items-center justify-center py-8 animate-fadeIn">
              ...
              <span className="ml-3 text-lg text-gray-700">ছবি বিশ্লেষণ করা হচ্ছে...</span>
            </div>
          )}
...
const analyzeImage = async (file: File) => {
  ...
  try {
    ...
    try {
      ...
      throw new Error('বিশ্লেষণের ফলাফল পার্স করতে ব্যর্থ হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।');
    }
  } catch (error) {
    console.error('Error analyzing image:', error);
    if (error instanceof Error && error.message.includes('API key not valid')) {
      throw new Error('অবৈধ API কী। অনুগ্রহ করে আপনার Gemini API কী যাচাই করুন।');
    }
    throw new Error('ছবি বিশ্লেষণ করতে ব্যর্থ হয়েছে। অনুগ্রহ করে আবার চেষ্টা করুন।');
  }
};
